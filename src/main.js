...
function renderHome(workouts = historyWorkouts) {
  ...
  const recentHtml = recentWorkouts.length ? recentWorkouts.map(workout => `
    <button class="home-recent-item" type="button" data-home-workout="${escapeHtml(workout.id)}">
      <span class="home-recent-icon" aria-hidden="true"><span class="runory-shoe-icon" aria-hidden="true"></span></span>
...
function renderHistoryList(workouts = historyFilteredWorkouts()) {
  ...
  container.innerHTML = workouts.map(workout => `
    <article class="history-item" data-history-id="${escapeHtml(workout.id)}" data-history-view="${escapeHtml(workout.id)}">
      <div class="history-workout-mark" aria-hidden="true"><span class="runory-shoe-icon" aria-hidden="true"></span></div>
...
// === Runory icon system: supplied reference icons ===
const RUNORY_ICON_DATA = {
  home: "data:image/png;base64,",
  run: "data:image/png;base64,",
  dynamics: "data:image/png;base64,",
  calculator: "data:image/png;base64,",
  shoe: "data:image/png;base64,"
};

function applyRunoryIcons() {
  if (document.querySelector("#runoryIconStyles")) return;

  const style = document.createElement("style");
  style.id = "runoryIconStyles";
  style.textContent = `
    .runory-nav-icon {
      width: 18px;
      height: 18px;
    ...
    .runory-shoe-icon {
      ...
      display: block;
      background: var(--lime, #c9ff48);
      -webkit-mask-image: url("$data:image/png;base64,");
      mask-image: url("$data:image/png;base64,");
      -webkit-mask-repeat: no-repeat;
      mask-repeat: no-repeat;
      -webkit-mask-position: center;
      mask-position: center;
    ...
    .home-recent-icon .runory-shoe-icon {
      width: 24px;
      height: 24px;
    }
    .history-workout-mark .runory-shoe-icon {
      width: 23px;
      height: 23px;
    }
  `;
  ...
  const navIcons = {
    home: RUNORY_ICON_DATA.home,
    history: RUNORY_ICON_DATA.run,
    dynamics: RUNORY_ICON_DATA.dynamics,
    calculator: RUNORY_ICON_DATA.calculator
  };

  document.querySelectorAll(".app-nav [data-view-target]").forEach(button => {
    const type = button.dataset.viewTarget;
    const source = navIcons[type];
    if (!source) return;

    button.querySelectorAll("svg, img").forEach(icon => icon.remove());
    button.querySelector(".runory-nav-icon")?.remove();

    const icon = document.createElement("span");
    icon.className = "runory-nav-icon";
    icon.setAttribute("aria-hidden", "true");
    icon.style.webkitMaskImage = `url("${source}")`;
